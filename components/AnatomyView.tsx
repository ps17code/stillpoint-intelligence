...
const LAYERS: LayerRow[] = [
  {
    ...
    accent: "#C4A46C",
    cards: [
      { id: "germanium", name: "Germanium", status: "Constrained", description: "Trace metal that dopes glass to carry light through fiber optic cable. Essential for all fiber-based connectivity.", players: "Yunnan Chihong, Umicore, 5N Plus, Teck Resources", insight: "", mapped: true, downstream: ["fiber-optic-cable", "connectivity", "datacenter"], upstream: [] },
      ...
      { id: "gallium", name: "Gallium", status: "Constrained", description: "Byproduct of alumina refining. GaN power chips convert electricity in AI datacenters with 30% less loss than silicon. GaAs substrates power 5G amplifiers and defense radar. 98% Chinese primary supply.", players: "AXT, Alcoa, Metlen, Dowa, Navitas, 5N Plus", insight: "", mapped: true, downstream: ["optical-transceivers", "connectivity", "datacenter"], upstream: [] },
