...
const LAYERS: LayerRow[] = [
  {
    ...
    cards: [
      ...
      { id: "copper", name: "Copper", description: "Base metal mined from sulfide and oxide ores. Conducts power and signal across every datacenter system \u2014 bus bars, wiring harnesses, PCB traces, and heat exchangers. Each MW of capacity embeds roughly 25 tonnes.", players: "Codelco, Freeport-McMoRan, BHP, Southern Copper", insight: "", mapped: false, downstream: ["fiber-optic-cable", "server-boards", "power-transformers", "pdu", "liquid-cooling", "chillers", "air-handling", "power", "cooling", "connectivity", "compute", "datacenter"], upstream: [] },
      { id: "silicon", name: "Silicon", description: "Metalloid refined from quartz sand into ultra-high-purity wafers. The semiconductor substrate for every chip in the facility \u2014 GPUs, CPUs, memory, networking ASICs, power management ICs.", players: "Shin-Etsu, SUMCO, Siltronic, SK Siltron", insight: "", mapped: false, downstream: ["gpu", "hbm", "network-switches", "optical-transceivers", "server-boards", "compute", "connectivity", "datacenter"], upstream: [] },
      ...
      { id: "aluminum", name: "Aluminum", description: "Lightweight metal smelted from bauxite ore. Used in heat sinks, server chassis, rack frames, cooling assemblies, and structural enclosures. The dominant material for thermal management at scale.", players: "Alcoa, Rio Tinto, Norsk Hydro, Hindalco", insight: "", mapped: false, downstream: ["liquid-cooling", "air-handling", "rack-enclosures", "cooling", "physical-structure", "datacenter"], upstream: [] },
      { id: "lithium", name: "Lithium", description: "Alkali metal extracted from brine pools and hard rock deposits. Powers lithium-ion battery backup systems (UPS) that maintain uninterrupted datacenter operation during grid failures.", players: "Albemarle, SQM, Ganfeng Lithium, Pilbara Minerals", insight: "", mapped: false, downstream: ["ups-battery", "power", "datacenter"], upstream: [] },
      ...
      { id: "silver", name: "Silver", description: "Precious metal with the highest electrical conductivity of any element. Used in high-performance connectors, soldering materials, and signal-critical pathways where minimal resistance matters.", players: "Fresnillo, Newmont, Pan American Silver, KGHM", insight: "", mapped: false, downstream: ["server-boards", "compute", "datacenter"], upstream: [] },
      { id: "tin", name: "Tin", description: "Base metal mined from cassiterite ore. The primary material in lead-free solder that bonds components to every circuit board in the facility.", players: "Yunnan Tin, PT Timah, Minsur, Alphamin Resources", insight: "", mapped: false, downstream: ["server-boards", "compute", "datacenter"], upstream: [] },
  ...
  },
  {
    ...
    cards: [
      ...
      { id: "optical-transceivers", name: "Optical transceivers", description: "Modules that convert electrical signals to light and back. Built on gallium arsenide laser chips. Every fiber connection in a datacenter needs one on each end.", players: "Coherent, Lumentum, Broadcom, Intel, Cisco", insight: "", mapped: false, downstream: ["connectivity", "datacenter"], upstream: [] },
      { id: "network-switches", name: "Network switches", description: "Route data between servers and racks at high speed. Built around custom silicon ASICs designed for packet processing at terabit scale.", players: "Broadcom, Cisco, Arista, Juniper, NVIDIA (Spectrum)", insight: "", mapped: false, downstream: ["connectivity", "datacenter"], upstream: [] },
      { id: "gpu", name: "GPUs / AI accelerators", description: "Parallel processors for AI training and inference. Fabricated on silicon wafers at 3-5nm, packaged with stacked memory. The highest-value component in any AI datacenter.", players: "NVIDIA, AMD, Broadcom, Google (TPU), Intel", insight: "", mapped: false, downstream: ["compute", "datacenter"], upstream: [] },
      { id: "hbm", name: "HBM memory", description: "Memory chips stacked vertically and bonded directly to GPUs. Enables the data throughput AI workloads require. Without it, GPUs can\u2019t be fed fast enough.", players: "SK Hynix, Samsung, Micron", insight: "", mapped: false, downstream: ["compute", "datacenter"], upstream: [] },
      { id: "server-boards", name: "Server boards", description: "Circuit boards that connect GPUs, CPUs, memory, and networking into a single server. Fabricated by layering copper traces onto fiberglass substrate, then populated with components via solder.", players: "Foxconn, Quanta, Wiwynn, Supermicro", insight: "", mapped: false, downstream: ["compute", "datacenter"], upstream: [] },
      { id: "power-transformers", name: "Power transformers", description: "Step down utility voltage for datacenter use. Copper or aluminum wire wound around a laminated steel core. Lead times currently 2-3 years due to competing grid demand.", players: "Hitachi Energy, Siemens Energy, ABB, GE Vernova", insight: "", mapped: false, downstream: ["power", "datacenter"], upstream: [] },
      { id: "ups-battery", name: "UPS / battery systems", description: "Battery packs that provide uninterrupted power during grid failures. Lithium-ion cells assembled into modules with power management electronics. Competing with EV sector for cell supply.", players: "Eaton, Vertiv, Schneider Electric, CATL, Samsung SDI", insight: "", mapped: false, downstream: ["power", "datacenter"], upstream: [] },
      { id: "pdu", name: "Power distribution units", description: "Distribute power from the transformer to individual racks. Bus bars, breakers, and metering assembled into switchgear cabinets. Every rack connects through a PDU.", players: "Eaton, Schneider Electric, Vertiv, Legrand", insight: "", mapped: false, downstream: ["power", "datacenter"], upstream: [] },
      { id: "generators", name: "Backup generators", description: "Diesel or natural gas engines paired with alternators that supply emergency power. Activated within seconds of a grid outage. Required for uptime SLAs.", players: "Caterpillar, Cummins, Rolls-Royce (MTU), Generac", insight: "", mapped: false, downstream: ["power", "datacenter"], upstream: [] },
      { id: "liquid-cooling", name: "Liquid cooling systems", description: "Cold plates mounted on GPUs circulate liquid coolant to remove heat. Machined from copper or aluminum with precision microchannels. Essential as GPU power density exceeds what air cooling can handle.", players: "Vertiv, CoolIT, GRC, LiquidCool Solutions, Motivair", insight: "", mapped: false, downstream: ["cooling", "datacenter"], upstream: [] },
      { id: "chillers", name: "Chillers", description: "Refrigeration units that cool the water or coolant circulating through the facility. Compressors and heat exchangers built from copper coils and steel housings.", players: "Trane (Ingersoll Rand), Carrier, Johnson Controls, Daikin", insight: "", mapped: false, downstream: ["cooling", "datacenter"], upstream: [] },
      { id: "air-handling", name: "Air handling units", description: "Fans and coil systems that circulate and condition air through server rooms. Aluminum and copper heat exchangers with variable-speed fan motors.", players: "Schneider Electric, Vertiv, Stulz, Munters", insight: "", mapped: false, downstream: ["cooling", "datacenter"], upstream: [] },
      { id: "rack-enclosures", name: "Rack enclosures", description: "Steel and aluminum frames that house servers, switches, and cabling. Standardized 42U or 48U form factor. Fabricated from sheet metal, powder coated.", players: "Rittal, Schneider Electric (APC), Vertiv, CPI", insight: "", mapped: false, downstream: ["physical-structure", "datacenter"], upstream: [] },
    ],
  },
  {
    label: "SUBSYSTEMS",
