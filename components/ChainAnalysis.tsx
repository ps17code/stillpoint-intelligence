              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 3 }}>
                {[
                  ...
                  <div key={i} style={{ display: "flex", gap: 6, alignItems: "baseline" }}>
                    ...
                    <p style={{ fontSize: 10, color: "rgb(160, 152, 136)", lineHeight: 1.4, margin: 0, whiteSpace: "nowrap" }}>{b}</p>
                  </div>
                ))}
              </div>
            </div>
...
/** Key takeaways for the featured chain — rendered in the right panel */
