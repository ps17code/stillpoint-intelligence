          ...
          <div style={{ background: "rgb(27, 27, 27)", border: "0.1px solid rgb(36, 36, 36)", borderRadius: 5, overflow: "hidden", ...(selectedFeaturedChain ? { animation: "fadeSlideDown 0.4s ease-out" } : {}) }}>
            ...
            <div style={{ padding: "0 15px 10px" }}>
              ...
              {chainTreeTab === "diagram" && (
                ...
                {/* Input cost stack table — chain page only */}
                {selectedFeaturedChain && (() => {
                  const COST_ROWS = [
                    { input: "Fiber", qty: "9M fiber-km", price: "$6.30 / fiber-km", cost1: "$56.7M", cost20: "$1.13B", pct: "100%" },
                    { input: "GeCl₄", qty: "~2.66 t", price: "~$2,500 / kg", cost1: "~$6.6M", cost20: "~$133M", pct: "~12%" },
                    { input: "Germanium", qty: "~0.9 t", price: "~$5,800 / kg", cost1: "~$5.2M", cost20: "~$104M", pct: "~9%" },
                  ];
            ...
            return (
              ...
              <div style={{ animation: "fadeSlideDown 0.3s ease-out", background: "rgb(27, 27, 27)", border: "0.1px solid rgb(36, 36, 36)", borderRadius: 5, overflow: "hidden", marginTop: 10 }}>
                <div style={{ padding: "10px 15px" }}>
                  <p style={{ fontSize: 10, color: warmWhite, margin: 0, textTransform: "uppercase", letterSpacing: "0.08em", fontWeight: 500, fontFamily: "'Geist Mono', monospace" }}>Subsystems</p>
                </div>
