...
- **descriptor_pill:** Bauxite-producing region
- **quantity_pill:** ~97M t/yr bauxite
- **status:** Active
...
- **value_note:** Gallium not separately priced at mine
- **descriptor_pill:** Bauxite-producing region
- **quantity_pill:** ~100M t/yr bauxite
- **status:** Active
...
- **descriptor_pill:** Bauxite-producing region
- **quantity_pill:** ~90M t/yr domestic + imports
- **status:** Active
...
- **value_note:** Gallium not separately priced at mine
- **descriptor_pill:** Bauxite-producing region
- **quantity_pill:** ~33M t/yr bauxite
- **status:** Active
...
- **descriptor_pill:** Bauxite-producing region
- **quantity_pill:** ~26M t/yr bauxite
- **status:** Active
...
- **descriptor_pill:** Bauxite mine
- **quantity_pill:** ~14M t/yr bauxite
- **status:** Active
...
- **descriptor_pill:** Bauxite mine
- **quantity_pill:** ~50M+ t/yr bauxite
- **status:** Active
...
- **value_note:** Gallium not separately priced
- **descriptor_pill:** Bauxite mine
- **quantity_pill:** ~10M t/yr bauxite
- **status:** Active
...
- **value_note:** Gallium not separately priced
- **descriptor_pill:** Bauxite mine
- **quantity_pill:** ~3-5M t/yr bauxite
- **status:** Active
...
- **descriptor_pill:** Bauxite mine
- **quantity_pill:** ~36M t/yr bauxite
- **status:** Active
...
- **descriptor_pill:** Bauxite mine
- **quantity_pill:** ~25M t/yr bauxite
- **status:** Active
...
- **descriptor_pill:** Bauxite mine
- **quantity_pill:** ~12M t/yr bauxite
- **status:** Active
...
- **descriptor_pill:** Bauxite mine cluster
- **quantity_pill:** ~15M t/yr bauxite
- **status:** Active
...
- **descriptor_pill:** Bauxite mine cluster
- **quantity_pill:** ~20M t/yr bauxite
- **status:** Active
...
- **descriptor_pill:** Alumina refineries + Ga recovery
- **quantity_pill:** ~590 t/yr primary Ga
- **status:** Partial
...
- **descriptor_pill:** Gallium extraction (planned)
- **quantity_pill:** 100 t/yr target 2028
- **status:** Pre-FID
...
- **descriptor_pill:** Integrated aluminum producer
- **quantity_pill:** ~$11B market cap
...
- **descriptor_pill:** Alumina refinery + Ga recovery
- **quantity_pill:** 50 t/yr target 2028
- **status:** Demo stage
...
- **descriptor_pill:** Gallium demo plant
- **quantity_pill:** ~3.5 t/yr demo
- **status:** Demo stage
...
- **descriptor_pill:** Critical minerals JV
- **quantity_pill:** 40 t/yr Ga target 2029
- **status:** Planned
...
- **descriptor_pill:** Zinc smelter (demolition)
- **quantity_pill:** 126-145 t/yr Ga in feed
- **status:** Demolition
...
- **descriptor_pill:** High-purity Ga refiner
- **quantity_pill:** ~10-30 t/yr refined Ga
- **status:** Active
...
- **descriptor_pill:** Specialty metals refiner
- **quantity_pill:** ~2-5 t/yr refined Ga
- **status:** Active
...
- **descriptor_pill:** Process IP + GaAs recycler
- **quantity_pill:** Limited direct output
- **status:** Active
...
- **descriptor_pill:** Chinese high-purity refiner
- **quantity_pill:** MOCVD precursors + Ga metal
- **status:** Active
...
- **value_note:** null
- **descriptor_pill:** Chinese high-purity refiner
- **quantity_pill:** Aggregated refining capacity
- **status:** Active
...
- **descriptor_pill:** ~590 t/yr primary
- **quantity_pill:** ~$145M @ $245/kg
- **status:** Active
...
- **descriptor_pill:** ~15-30 t/yr refined
- **quantity_pill:** ~$26-52M @ $1,750/kg
- **status:** Active
...
- **descriptor_pill:** ~320 t/yr refined
- **quantity_pill:** ~$200-250M realized
- **status:** Active
...
- **feeds_into:** [company-vital-materials, company-zhuzhou-smelter-group, company-dowa-holdings, company-5n-plus]
- **show_on_tree:** true
...
- **feeds_into:** [aggregate-western-refined-supply-gallium]
- **show_on_tree:** true
- **show_in_wtmi:** true
...
- **feeds_from:** [aggregate-chinese-bauxite-refineries]
- **feeds_into:** [aggregate-chinese-primary-supply-gallium]
- **show_on_tree:** true
- **show_in_wtmi:** false
- **wtmi_category_tag:** null
...
- **feeds_from:** [company-vital-materials, company-zhuzhou-smelter-group]
- **feeds_into:** [aggregate-global-supply]
- **show_on_tree:** true
- **show_in_wtmi:** true
- **wtmi_category_tag:** Market maker
...
- **feeds_from:** [company-dowa-holdings, company-5n-plus, company-indium-corporation]
- **feeds_into:** [aggregate-global-supply]
- **show_on_tree:** true
- **show_in_wtmi:** false
- **wtmi_category_tag:** null
...
- **feeds_from:** [aggregate-chinese-primary-supply-gallium, aggregate-western-refined-supply-gallium]
- **feeds_into:** []
- **show_on_tree:** true
- **show_in_wtmi:** false
- **wtmi_category_tag:** null
...
*Stillpoint Intelligence · Gallium Supply Tree · Framework v5.1 · April 2026*
