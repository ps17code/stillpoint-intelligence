...
- Global refined production is ~320t/yr of the high-purity metal that actually reaches semiconductor customers. Roughly 290t is Chinese; ~15-30t is non-Chinese, almost entirely in Japan via Dowa Holdings. Underneath that, China holds ~1,000t/yr of installed primary capacity running at ~59% utilization — a deliberate overhang Beijing can tighten or release depending on the policy cycle. The United States has not produced primary gallium since 1987.

- Price has risen from $298/kg to $2,269/kg since 2020 on western retail benchmarks, with a 9x spread between Chinese domestic ($245/kg, SMM April 2026) and western markets. The spread persists because export licensing prevents arbitrage.

- Demand accelerating from GaN power electronics (42% CAGR), defense radar modernization, and AI datacenter 800V power conversion architecture (a new high-voltage DC standard NVIDIA is rolling out across its AI factories). Every major western demand vector is stable or growing. Chinese domestic consumption dominated by NdFeB magnets and LED production.
...
### Step 01: RECOVERED FROM ALUMINA REFINERIES
- **Description:** Gallium is never mined on its own. It exists as a trace impurity — about 50 parts per million — inside bauxite, the ore that aluminum is made from. When aluminum producers process bauxite into alumina using the standard industrial Bayer process, gallium dissolves into the same liquid byproduct stream. Refineries that want gallium install ion-exchange resins that grab the gallium out of that stream and turn it into 99.99%-pure metal. A smaller volume is recovered the same way from zinc smelter waste.
- **Why it's hard:** Only about 10-15% of the gallium sitting inside the bauxite actually gets captured. The rest ends up in waste mud. You cannot increase gallium output without processing more bauxite, which means gallium supply is tied to aluminum production decisions — not gallium demand signals. This is the structural reason supply cannot scale on its own.
- **Who can do it:** Around 20 alumina refineries globally have installed gallium recovery equipment. The vast majority are in China. A handful operate in Japan, South Korea, Russia, and Slovakia. Germany, Hungary, and Kazakhstan shut down their gallium output between 2013 and 2016 because they could not compete with Chinese pricing. The United States stopped producing primary gallium in 1987.
- **Output:** ~600t of low-purity gallium metal per year

### Step 02: PURIFIED TO SEMICONDUCTOR GRADE
- **Description:** The 99.99% metal coming out of Step 1 is pure enough for dopants and alloys but not pure enough for semiconductors. Chipmakers need gallium at 99.9999% purity or better — five to six more nines. Getting there requires specialized processes: zone refining (slowly re-melting the metal to drive impurities to one end), vacuum distillation, and electrolytic refining. Different applications need different purity grades. LED makers typically need 99.9999%. Defense radar chips need 99.99999%. The highest-grade material, used in next-generation chips, needs 99.999999%.
- **Why it's hard:** Every additional "nine" of purity is harder than the last. Removing the final parts per billion of iron, copper, and zinc requires proprietary process knowledge that cannot be bought off the shelf. Not every refinery that produces low-purity gallium can refine it to semiconductor grade. The combination of primary extraction (Step 1) and high-purity refining (Step 2) is what creates the chokepoint — China controls both.
- **Who can do it:** Only a handful of companies globally. Chinese refiners (Vital Materials, Zhuzhou Smelter Group, Zhuzhou Keneng) dominate. Outside China, Japan's Dowa Holdings leads; smaller capacity exists at 5N Plus (Canada), Indium Corporation (USA), and PPM Pure Metals (Germany).
- **Output:** ~320t of high-purity refined gallium per year

### Step 03: TURNED INTO WAFERS AND CHIPS
- **Description:** High-purity gallium does not go straight into a chip. It first gets combined with another element to form a compound — most commonly gallium arsenide (GaAs) or gallium nitride (GaN) — and grown into large crystals. Those crystals are sliced into thin circular wafers, which are the foundation on which semiconductor chips are built. Separately, specialty chemical companies turn some of the gallium into precursor chemicals (trimethylgallium, triethylgallium) that chipmakers use to grow thin GaN layers directly onto other materials during manufacturing.
- **Why it's hard:** Different end products need different specifications. A GaAs wafer going into a 5G phone amplifier needs a different electrical property than a GaAs wafer going into a satellite solar cell. A GaN chip for a military radar needs ultra-low defect density. The industry is also in the middle of shifting from 4-inch wafers to 6-inch and 8-inch wafers to lower costs per chip — a transition that requires new equipment throughout the chain.
- **Who can do it:** AXT operates what it believes to be the world's largest compound semiconductor wafer facility, located in Beijing. Other major wafer producers include Sumitomo Electric (Japan), Freiberger Compound Materials (Germany), and IQE (UK). Downstream chipmakers building finished GaN devices include Infineon, Wolfspeed, Navitas, Qorvo, Broadcom, MACOM, and Transphorm. Nichia (Japan) dominates GaN-based LEDs.
- **Output:** ~320t of gallium enters the wafer and device stage, producing ~$26B of downstream semiconductor products per year
...
#### Chinese Bauxite Refineries
- **Type:** Aggregate primary supply node
- **Layer:** Primary Producer
- **Location:** Guangxi, Shandong, Henan, Shanxi, Yunnan (China)
- **Key stat:** ~1,000 t/yr installed capacity · ~590 t/yr actual production
- **Risk:** Export licensing and ban regime creates structural supply uncertainty for non-Chinese buyers.
- **Role:** China's dominance of gallium production is a direct consequence of its dominance of alumina refining — the world's largest aluminum industry processes the world's largest bauxite volume, and gallium recovery is a near-zero marginal cost addition. Chinese primary capacity expanded from 140 t/yr in 2010 to ~1,000 t/yr by 2022. The installed capacity overhang means China could flood the western market if political conditions changed — or starve it further if they do not.
- **Investment angle:** No direct western investment access. Chinese alumina producers are state-owned or state-affiliated.

#### Vital Materials Co.
- **Type:** Private company
- **Layer:** Refiner
- **Location:** Guangdong, China
- **Key stat:** Leading Chinese high-purity gallium refiner · 4N–8N grades
- **Risk:** Export-controlled; serves Chinese domestic semiconductor and display industries.
- **Role:** Vital Materials is one of China's largest integrated producers of specialty metals including gallium, indium, germanium, tellurium, and rare earths. Operates high-purity refining capacity servicing the domestic semiconductor industry and produces MOCVD precursor chemicals — the gallium-containing liquids used to grow thin GaN layers during chip manufacturing. Together with Zhuzhou Smelter Group and Zhuzhou Keneng, Vital anchors Chinese control over downstream high-purity gallium supply.
- **Investment angle:** Not directly investable. Privately held Chinese company with no listed western equity.

#### Zhuzhou Smelter Group
- **Type:** State-owned enterprise
- **Layer:** Primary Producer + Refiner (zinc route)
- **Location:** Zhuzhou, Hunan Province, China
- **Key stat:** Major Chinese gallium refiner · Zinc-route production
- **Risk:** Output tied to zinc smelter economics; not independently scalable.
- **Role:** One of China's largest integrated zinc producers, with gallium recovery as a byproduct of zinc hydrometallurgy. Operates refining capacity feeding the Chinese domestic semiconductor and magnet industries. Unlike Vital Materials' bauxite-route economics, Zhuzhou's output is constrained by the economics of zinc smelting.
- **Investment angle:** Limited Chinese listed exposure. No direct western investment vehicle.

#### Dowa Holdings
- **Type:** Public company (Tokyo Stock Exchange)
- **Layer:** Refiner
- **Location:** Tokyo, Japan
- **Key stat:** Leading non-Chinese high-purity gallium producer · 6N+ for GaAs wafers
- **Risk:** Dependent on imported primary gallium feedstock; pricing power offset by scale constraints.
- **Role:** Dowa Holdings is the western world's structurally most important high-purity gallium refiner outside China. Serves Japanese and allied GaAs wafer manufacturers and LED epitaxy customers requiring 6N purity. When China's December 2024 ban took effect, Dowa's role became structurally essential for western GaAs supply. Ticker 5714.T, market cap ~¥800B (~$5.5B).
- **Investment angle:** Indirect gallium exposure as part of a diversified specialty metals portfolio. Gallium revenue not separately disclosed. Thesis: Dowa captures premium pricing as western buyers pay to avoid Chinese supply risk.

#### 5N Plus Inc.
- **Type:** Public company (TSX)
- **Layer:** Refiner
- **Location:** Montreal, Quebec, Canada
- **Key stat:** CAD 3.1B market cap · Multi-metal specialty refiner · VNP TSX
- **Risk:** Gallium exposure dilute; germanium and tellurium dominate specialty segment revenue.
- **Role:** Operates high-purity refining of gallium, germanium, bismuth, indium, selenium, tellurium, and cadmium from its Montreal campus. Only vertically integrated western producer of space solar cells (via AZUR SPACE subsidiary in Germany). FY25 revenue $391.1M (+35% YoY), Adjusted EBITDA $92.4M (+73% YoY). Stock up 532% over 12 months.
- **Investment angle:** Broad exposure to western critical minerals refining capacity. AZUR space solar backlog (265 days) and multi-year take-or-pay contracts provide revenue visibility. Gallium upside is optionality within the thesis rather than a standalone driver.

#### Indium Corporation
- **Type:** Private company
- **Layer:** Refiner + Recycler
- **Location:** Rome and Clinton, New York, USA
- **Key stat:** Process IP owner for non-Chinese gallium extraction · Private
- **Risk:** Private company; limited public financial visibility.
- **Role:** The United States' sole scale producer of high-purity gallium from new scrap generated in GaAs device manufacturing. Substantial GaAs wafer fabrication waste is reprocessed at the company's New York facility. Indium also developed the extraction process now deployed by Rio Tinto at Vaudreuil, making Indium the de facto IP owner for non-Chinese gallium primary extraction — paralleling Umicore's position in the germanium chain.
- **Investment angle:** Not directly investable as an equity. Strategic importance flows through partners: Rio Tinto for primary extraction, OEM customers for recycled supply.

#### PPM Pure Metals
- **Type:** Private company
- **Layer:** Refiner
- **Location:** Langelsheim, Germany
- **Key stat:** European specialty refiner · Private
- **Risk:** Small scale; dependent on European scrap and imported primary.
- **Role:** Produces ultra-high purity gallium (7N+) for semiconductor, detector, and defense applications in Europe. Serves niche markets where 7N+ purity is required and where supply from sanctioned or export-controlled jurisdictions is unacceptable. Represents Europe's residual strategic refining capability for defense-grade gallium.
- **Investment angle:** No direct investment vehicle. Strategic importance as a European sovereign supplier rather than a commercial scale producer.

#### AXT, Inc.
- **Type:** Public company (Nasdaq)
- **Layer:** Substrate Manufacturer
- **Location:** Fremont, California (HQ) · Beijing, China (manufacturing via Tongmei)
- **Key stat:** $4.59B market cap · World's largest III-V wafer facility (III-V = compound semiconductors built from group III and V elements, like gallium arsenide) · AXTI
- **Risk:** Chinese manufacturing; export permits constrain near-term revenue growth.
- **Role:** Designs, develops, and manufactures compound semiconductor wafer substrates — gallium arsenide (GaAs), indium phosphide (InP), and germanium (Ge). The Tongmei facility in Beijing is what management believes to be the world's largest wafer production facility for these compound semiconductors. AXT is the downstream chokepoint for converting refined gallium into semiconductor substrates. The 2025 surge in InP revenue (+250% sequentially in Q3) signaled that AI datacenter optical build-out is pulling compound semiconductor demand at scale.
- **Investment angle:** The most liquid western-listed proxy for both the gallium substrate chokepoint and the AI-driven compound semiconductor demand cycle. 12-month return +287%.

#### Alcoa Corporation
- **Type:** Public company (NYSE, ASX)
- **Layer:** Primary Producer (planned)
- **Location:** Pittsburgh (HQ) · Wagerup or Pinjarra, Western Australia (gallium project)
- **Key stat:** 100 t/yr gallium project announced · AA NYSE
- **Risk:** FID pending; project immaterial to Alcoa's overall financials but structurally transformative for western supply.
- **Role:** Alcoa and the Japan Australia Gallium Associates joint venture (Sojitz + JOGMEC) announced in October 2025 the feasibility of producing 100 t/yr gallium at a Western Australian alumina refinery. The US and Australian governments committed to join a special purpose vehicle to finance construction, with each government receiving gallium offtake in proportion to its investment. If executed, becomes the single largest non-Chinese gallium production facility globally — roughly 10% of current global demand.
- **Investment angle:** Indirect exposure to gallium through a larger aluminum-producer thesis. Gallium revenue at 100 t/yr and $2,000/kg would contribute ~$200M annually — meaningful but not transformative. The structural importance: Alcoa becomes the western gallium chokepoint if JAGA delivers.

#### Metlen Energy & Metals
- **Type:** Public company (Athens, London)
- **Layer:** Primary Producer (under construction)
- **Location:** Athens, Greece (HQ) · Agios Nikolaos, Viotia (gallium facility)
- **Key stat:** Europe's first industrial gallium producer · 50 t/yr by 2028 · MYTIL
- **Risk:** Execution risk scaling from 5kg first production to 50 t/yr commercial.
- **Role:** Took Final Investment Decision in January 2025 on a €295.5M bauxite/alumina/gallium expansion at its Aluminium of Greece complex. Designated a Strategic Project under the EU Critical Raw Materials Act. First production of 5 kg achieved in January 2026 — proof that the patented extraction technology works at industrial scale. Targets ramp to 50 t/yr by 2028, which would fully cover EU gallium demand.
- **Investment angle:** Direct European exposure to the gallium-supply-sovereignty theme, backed by €90M EIB financing approved January 2026. Benefits from vertical integration (bauxite mining through alumina to gallium), co-location with existing refineries, and sovereign EU support.

#### Rio Tinto / Indium Corporation JV
- **Type:** Aggregate supply node (public company + private partner)
- **Layer:** Primary Producer (demo stage)
- **Location:** Vaudreuil Refinery, Saguenay, Quebec, Canada
- **Key stat:** 3.5 t/yr demo plant · 40 t/yr commercial target · RIO NYSE/ASX
- **Risk:** Early stage; commercial timeline unspecified.
- **Role:** Announced in May 2025 the successful laboratory-scale extraction of gallium from feed sourced at Rio Tinto's Vaudreuil alumina refinery. In March 2026, Rio Tinto announced advancement of the R&D project with Canadian federal and Quebec provincial government support. Demonstration plant targets up to 3.5 t/yr. Transition to commercial-scale operation could see production reach 40 t/yr — representing 5-10% of current world gallium production.
- **Investment angle:** Optionality on Canadian critical minerals production via an existing diversified mining platform. Gallium demo plant is financially immaterial to Rio Tinto's $100B+ market cap. Thesis analogous to Teck Resources in the germanium chain.

#### Korea Zinc / Crucible JV
- **Type:** Aggregate supply node (Korean public + US government + private)
- **Layer:** Primary Producer + Refiner (planned)
- **Location:** Clarksville, Tennessee, USA (former Nyrstar site)
- **Key stat:** $7.4B facility · DoD 40% equity stake · 2029 commercial operations
- **Risk:** Ground not broken; 2029 commercial operations leaves ~3-year execution window.
- **Role:** In December 2025, Korea Zinc announced the Crucible JV — an unprecedented public-private partnership with the US government holding a 40% equity stake, JPMorgan advising, and $4.7B in US government loans plus $210M in CHIPS Act subsidies. The facility will demolish the existing Nyrstar zinc smelter and build a new $6.6B facility producing 540,000 tonnes annually of critical minerals including zinc, lead, copper, antimony, germanium, and gallium (~40 t/yr). The DoD equity stake is unprecedented for a processing facility.
- **Investment angle:** Korea Zinc is listed in Seoul with limited direct access for US investors. The strategic importance is that the JV formalizes US government commitment to rebuilding critical minerals processing on US soil, with gallium as one of the anchor minerals.

#### Nyrstar Tennessee Tailings
- **Type:** Aggregate supply node (Trafigura subsidiary)
- **Layer:** Primary Producer (transitional)
- **Location:** Clarksville, Tennessee, USA
- **Key stat:** 126-145 t/yr gallium in mine feed · Currently exported for refining
- **Risk:** Existing facility will be demolished for Korea Zinc JV construction.
- **Role:** Nyrstar's Clarksville operation processes zinc concentrate from five Tennessee mines, containing gallium at commercially recoverable grades — estimated at 126-145 t/yr in mine feed, currently exported for refining or stored in tailings ponds. Nyrstar's $90M facility plan from 2023 was absorbed into the Korea Zinc Crucible JV in December 2025. Until the new smelter is operational (2029), US gallium in zinc concentrate continues to flow overseas.
- **Investment angle:** Nyrstar is a Trafigura (private) subsidiary; no direct investment access. Strategic importance: Tennessee mine feed represents enough gallium to cover a substantial fraction of US demand if refining capacity existed domestically.

#### American Elements
- **Type:** Private company
- **Layer:** Refiner (small-scale)
- **Location:** Salt Lake City, Utah, USA
- **Key stat:** December 2024 expansion for gallium/germanium/antimony production
- **Risk:** Private; scale and timeline not publicly detailed.
- **Role:** Announced in December 2024 an expansion of its Salt Lake City production facilities to scale output of gallium, germanium, and antimony in various forms. Supplies research, industrial, and government customers with high-purity gallium metal and compounds. Scale is modest compared to refiners like Dowa or Vital Materials.
- **Investment angle:** No direct investment access. Represents residual US domestic specialty production capability.

#### China Primary Supply (aggregate)
- **Type:** Aggregate supply node
- **Layer:** Aggregate: Primary Producer
- **Location:** China
- **Key stat:** ~590 t/yr · ~98% of global primary supply
- **Risk:** Entirely subject to Chinese export control regime.
- **Role:** Aggregates the output of ~20 Chinese alumina refineries with gallium recovery, operating at ~59% of installed capacity. Chinese primary production structurally dominates the global market and has done since ~2010, when Chinese capacity expansion made competing producers in Germany, Hungary, and Kazakhstan uneconomic. The 2023 export licensing regime and 2024 US ban created a bifurcation that persists through the currently suspended licensing period.
- **Investment angle:** The central thesis variable. Every western position should be stress-tested against the Chinese policy regime.

#### Western Refined Supply (aggregate)
- **Type:** Aggregate supply node
- **Layer:** Aggregate: Refiner
- **Location:** Japan, Canada, Germany, USA, Slovakia
- **Key stat:** ~15-30 t/yr · Dominated by Dowa (Japan)
- **Risk:** Entirely dependent on imported Chinese primary feedstock.
- **Role:** Residual non-Chinese capacity for refining gallium to semiconductor-grade purity. Aggregate tonnage is small — roughly equivalent to what one medium-sized Chinese producer outputs. Strategic importance exceeds the tonnage because this refining capacity is the pipe through which all non-Chinese compound semiconductor gallium flows. The looming Alcoa, Metlen, Rio Tinto, and Korea Zinc projects represent a 10x expansion of this node by 2029.
- **Investment angle:** Not directly investable as an aggregate. Exposure is via individual refiners (Dowa, 5N Plus) and the emerging primary producers.

#### Global Supply
- **Type:** Global market aggregate
- **Layer:** Total worldwide gallium production
- **Key stat:** ~600 t/yr low-purity · ~320 t/yr refined · 98% Chinese
- **Risk:** Structural dependency on Chinese primary production and refining.
- **Role:** Combines Chinese primary production (~98%) with small contributions from Japan, South Korea, Russia, and Slovakia. Actual output is well below installed capacity because Chinese state-owned and state-affiliated alumina producers manage production to stabilize domestic pricing. Western recycling is concentrated at a single New York facility. The total supply picture is defined less by tonnage than by access: the gallium exists, but it is not reliably available to western buyers under the current policy regime.
- **Investment angle:** The global supply constraint is fundamentally an access constraint, not a geological one. The thesis rewards entities positioned to produce, refine, or convert gallium outside China.
...
##### AXT, Inc. · AXTI · Nasdaq · `Manufacturing / integration`
World's largest producer of compound semiconductor wafers — the downstream chokepoint converting refined gallium into GaAs and InP substrates.

---

#### Device Manufacturer layer

##### Navitas Semiconductor · NVTS · Nasdaq · `Technology`
Pure-play GaN power semiconductor manufacturer — the downstream demand proxy for AI datacenter 800V power conversion and EV onboard chargers.
...
This aggregate is on the page because it is the single most important variable in the entire gallium investment thesis. Every other entity here — AXT, Alcoa, Metlen, 5N Plus, Dowa, Navitas, Rio Tinto, Korea Zinc — derives its investability from its position relative to what China does.
...
AXT makes wafers — the thin circular discs that semiconductor chips are built on. Specifically, AXT makes the kind of wafers that silicon cannot replace: gallium arsenide for 5G phone power amplifiers, indium phosphide for the laser chips that connect GPUs inside AI datacenters, and germanium for satellite solar cells. Its Beijing facility is, by the company's account, the world's largest facility of its kind. When a 5G phone sends a signal, or when an NVIDIA GPU talks to another GPU via fiber, the underlying chip probably started its life as an AXT wafer.

Gallium matters to AXT because gallium arsenide and gallium-related substrates are its core product. AXT also owns joint ventures in China that purify raw gallium into the feedstock it uses, giving it cost control over its own input.

**How does value flow through this entity?**

AXT is the chokepoint where refined gallium becomes a finished product a chipmaker can actually use. Only a handful of companies globally can make gallium arsenide wafers at scale — AXT, Japan's Sumitomo Electric, Germany's Freiberger, the UK's IQE. Among these, AXT has the most capacity. It also has vertical integration advantages through its Chinese gallium purification JVs, which give it a cost structure competitors cannot easily match.

The catch: AXT's main facility is in Beijing, and every wafer shipped to a non-Chinese customer needs a Chinese export permit. Since the August 2023 export controls, permits have taken much longer to clear. AXT's 2025 gallium arsenide revenue was held back not by weak demand but by slow permits. The company cannot fix this — the variable is Chinese policy.

The indium phosphide business, by contrast, is booming. InP revenue grew 250% sequentially in Q3 2025 as AI datacenter demand for optical interconnect chips accelerated. This is the driver behind the stock's 287% gain over the past year.

**Key numbers**
- Manufacturing footprint: ~300,000 sq ft Beijing facility
- Segment mix: 68% substrates, 32% raw materials
- Q3 2025 InP revenue growth: +250% sequentially
- FY25 GaAs revenue run-rate: ~$28M (constrained by export permits)
- 2027 capex plan: $100-150M for greenfield expansion

**What to watch**
- Q1 2026 earnings (April 30) for InP trajectory and GaAs permit clearance rate
- November 2026 Chinese export control suspension expiry — reimposition caps AXT's GaAs revenue
- InP wafer capacity doubling plan for 2027

**Investment angle**

AXT is the cleanest western-listed bet on the gallium substrate chokepoint and the AI optical infrastructure buildout. The stock has already priced in considerable optionality — market cap is $4.59B on a company with negative EBITDA. The thesis requires InP growth to continue and GaAs permits to normalize. A return to pre-2023 Chinese export conditions would collapse the premium the stock currently trades at; further tightening would shift revenue mix even more toward InP (which is less permit-sensitive because fewer Chinese alternatives exist).

*Stillpoint Intelligence · Gallium Chain · Layer: Substrate Manufacturer. Sources: AXT SEC filings, Semiconductor Today. Not investment advice.*

---

### Navitas Semiconductor — Full Brief
*NVTS · Nasdaq*

**Metrics:**
- Market cap: ~$1.1B
- Revenue: $45.9M (FY2025)
- EBITDA: -$117M GAAP net loss (FY2025)
- Cash: $236.9M
- Stock price: ~$13 (implied from analyst $6.68 target)
- 12-month change: Volatile

**What is this and why does it matter here?**

Navitas designs and sells power chips — the tiny components that convert electricity from one voltage to another inside every phone charger, laptop adapter, EV battery charger, and datacenter rack. The company is the only public pure-play manufacturer focused on gallium nitride (GaN) and silicon carbide (SiC), the two next-generation materials displacing traditional silicon in power conversion. Everything Navitas sells is built on gallium-based or silicon-carbide-based chips.

Navitas matters to the gallium thesis as the **demand proxy**. When GaN adoption accelerates, Navitas's volumes rise. When it slows, they fall. The company is a clean-read instrument for GaN demand growth — especially in AI datacenters, which is the fastest-growing gallium demand vector.

**How does value flow through this entity?**

In 2025, Navitas pivoted hard. Management moved the company away from low-margin consumer chargers (USB-C fast chargers, laptop adapters) and toward high-margin industrial applications (AI datacenter power, EV onboard chargers, grid infrastructure). This shift cut revenue nearly in half in 2025 — from $83M to $46M — but raised the quality of the revenue that remained. Q4 2025 was the first quarter where high-power markets contributed the majority of sales.

The biggest growth lever is AI datacenters. In October 2025, Navitas announced it was designed into NVIDIA's new 800V DC power architecture — the standard NVIDIA is rolling out across its AI factories. Every GW of that architecture needs thousands of Navitas chips. Navitas also signed a manufacturing partnership with GlobalFoundries to produce GaN chips inside the US starting late 2026 — meaningful for defense and datacenter customers who need domestic supply chains.

Semiconductor revenue takes 18-36 months to convert from design win to volume shipments. Navitas announced $450M of design wins in 2024, which should convert through 2026-2028. The $236.9M cash balance provides runway to execute without further dilution.

**Key numbers**
- FY2025 revenue: $45.9M (vs. $83.3M FY2024 — pivot-driven decline)
- High-power share of Q4 2025 revenue: >50% for the first time
- GaN units shipped to date: 250M+
- 2024 design wins: $450M (converts 2026-2028)
- Q1 2026 revenue guidance: $8-8.5M

**What to watch**
- Q1 2026 earnings (May 5) — revenue trajectory and design-win conversion rate
- GlobalFoundries US GaN production availability (late 2026)
- NVIDIA 800V HVDC adoption pace — determines datacenter revenue ramp

**Investment angle**

Navitas is the highest-beta public exposure to GaN demand. For investors with conviction on AI datacenter buildout and GaN adoption curves, it's the most concentrated pure-play on public markets — no other listed company lives or dies on GaN volumes this completely. The trade-off: the stock has run well ahead of fundamentals (analyst 12-month target implies ~50% downside), the company is still loss-making, and the pivot execution is mid-flight. Exposure to Navitas is exposure to GaN demand growth, not to gallium pricing directly — higher gallium prices raise Navitas's input costs rather than benefit the company.

*Stillpoint Intelligence · Gallium Chain · Layer: Device Manufacturer. Sources: Navitas SEC filings, NVIDIA and GlobalFoundries partnership announcements. Not investment advice.*
...
- **April 30, 2026** — AXT Q1 2026 earnings release
- **May 5, 2026** — Navitas Q1 2026 earnings release
...
- **H2 2026** — GlobalFoundries US GaN manufacturing availability (Navitas partnership)
...
### Upstream
Gallium is a raw material with no meaningful upstream dependencies at the platform level. The feedstock (bauxite, zinc ore) is abundant and not a supply constraint. The constraint is refining, not mining.

### Downstream
- **GaAs Substrates** — The primary downstream conversion product for gallium. AXT, Sumitomo Electric, Freiberger, IQE. End uses: 5G handset RF power amplifiers, LEDs, satellite solar cells, laser diodes.
- **GaN Devices (Power + RF)** — The fastest-growing downstream application. Navitas, Wolfspeed, Infineon, Qorvo, Broadcom, MACOM. End uses: AI datacenter 800V HVDC, EV onboard chargers, 5G/6G base stations, defense radar.
- **LED Lighting** — Mature but large application. Nichia, Cree, Lumileds, OSRAM. End uses: General lighting, automotive, display backlighting.
- **NdFeB Magnets** — Major Chinese domestic consumption channel. Gallium used as ~0.1-0.2% dopant. End uses: EV traction motors, wind turbines.
- **Defense Radar & EW** — Strategically critical downstream. Raytheon (RTX), Lockheed Martin (LMT), Northrop Grumman (NOC), BAE, L3Harris. End uses: AN/SPY-6, LTAMDS, Patriot, F-35 APG-81, G/ATOR, Next Generation Jammer.
- **Satellite Solar Cells** — Growing application driven by LEO constellation deployment. 5N Plus (AZUR), Spectrolab. End uses: Starlink, OneWeb, military satellite systems.
