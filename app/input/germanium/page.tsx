...
export default function GermaniumInputPage() {
  ...
  const IDEA_BRIEFS: Record<string, {
    name: string;
    ticker: string;
    category: string;
    ...
    umicore: {
      ...
      metrics: [
        ...
        { label: "Stock", value: "\u20ac17.26" },
        { label: "12mo", value: "+131%" },
      ],
      sections: [
        {
          label: "What is this and why does it matter here?",
          items: [
        ...
        {
          label: "How does value flow through this entity?",
          items: [
    ...
    "5n-plus": {
      ...
      metrics: [
        ...
        { label: "Stock", value: "~C$42" },
        { label: "12mo", value: "+600%" },
      ],
      sections: [
        {
          label: "What is this and why does it matter here?",
    ...
    lightpath: {
      ...
      metrics: [
        ...
        { label: "EBITDA", value: "-$14.9M" },
        { label: "Stock", value: "~$12.83" },
        { label: "12mo", value: "+180%" },
      ],
      sections: [
        {
          label: "What is this and why does it matter here?",
    ...
    "blue-moon": {
      ...
      metrics: [
        ...
        { label: "Resource", value: "1Mt" },
        { label: "Contained Ge", value: "870t" },
        { label: "Backing", value: "Oaktree/Hartree/Teck" },
        { label: "Target", value: "2028" },
      ],
      sections: [
        {
          label: "What is this and why does it matter here?",
    ...
    teck: {
      ...
      metrics: [
        ...
        { label: "Ge output", value: "8-10t/yr" },
        { label: "Expansion", value: "+4t by 2027" },
        { label: "Trail capex", value: "C$850M" },
        { label: "Blue Moon", value: "8% stake" },
      ],
      sections: [
        {
          label: "What is this and why does it matter here?",
    ...
    "yunnan-chihong": {
      ...
      metrics: [
        { label: "Exchange", value: "Shanghai" },
        { label: "Ge output", value: "56t/yr" },
        { label: "Reserves", value: "600+ t" },
        { label: "Parent", value: "Chinalco" },
        { label: "Wafer cap", value: "300k/yr" },
      ],
      sections: [
        {
          label: "What is this and why does it matter here?",
        ...
        {
          label: "How does this entity affect the rest of the chain?",
          items: [
    ...
    "stl-gecamines": {
      ...
      category: "Feedstock supplier",
      metrics: [
        { label: "Ownership", value: "GFI 70%/G\u00e9camines 30%" },
        { label: "Slag", value: "14M tonnes" },
        { label: "Ge potential", value: "700+ t" },
        { label: "Offtake", value: "100% Umicore" },
        { label: "First export", value: "Oct 2024" },
      ],
      sections: [
        {
          label: "What is this and why does it matter here?",
    ...
    "germanium-metal": {
      ...
      metrics: [
        { label: "Price", value: "$8,597/kg" },
        { label: "2023 price", value: "~$1,340/kg" },
        { label: "Change", value: "+541%" },
        { label: "Global supply", value: "~230t/yr" },
        { label: "China share", value: "83%" },
      ],
      sections: [
        {
          label: "What is this and why does it matter here?",
        ...
        {
          label: "How does the market work?",
          items: [
          ...
          return (
            ...
            >
              <div
                ...
                style={{
                  width: 720, maxHeight: "85vh", background: "#141210",
